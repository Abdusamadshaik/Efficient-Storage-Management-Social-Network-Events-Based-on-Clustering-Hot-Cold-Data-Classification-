function varargout = Mongo_Datas(varargin)
% MONGO_DATAS MATLAB code for Mongo_Datas.fig
%      MONGO_DATAS, by itself, creates a new MONGO_DATAS or raises the existing
%      singleton*.
%
%      H = MONGO_DATAS returns the handle to a new MONGO_DATAS or the handle to
%      the existing singleton*.
%
%      MONGO_DATAS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MONGO_DATAS.M with the given input arguments.
%
%      MONGO_DATAS('Property','Value',...) creates a new MONGO_DATAS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Mongo_Datas_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Mongo_Datas_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Mongo_Datas

% Last Modified by GUIDE v2.5 15-Apr-2021 08:18:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Mongo_Datas_OpeningFcn, ...
                   'gui_OutputFcn',  @Mongo_Datas_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Mongo_Datas is made visible.
function Mongo_Datas_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Mongo_Datas (see VARARGIN)

% Choose default command line output for Mongo_Datas
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Mongo_Datas wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Mongo_Datas_OutputFcn(hObject, eventdata, handles) 
